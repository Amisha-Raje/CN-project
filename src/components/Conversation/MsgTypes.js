        ...
        backgroundColor: el.incoming
         ...
         :theme.palette.primary.main,
          ...
          >
             ...
             <Stack p={2} direction="row" spacing={3} lignItems="center" sx={{backgroundColor: theme.palette.background.paper, borderRadius: 1}}>
            <Image size={48}/>
         ...
         :theme.palette.primary.main,
          ...
          >
            <Stack spacing={2}>
              ...
              <Stack spacing={2}>
              <Typography variant="subtitle2">Creating Chat App
              </Typography>
